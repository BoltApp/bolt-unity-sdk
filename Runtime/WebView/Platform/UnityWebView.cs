    ...
    public class UnityWebView : IBoltWebView
    {
        ...
        private void InitializeWebView()
        {
            ...
            webViewObject.Init(
                ...
                started: (msg) => Debug.Log($"WebView load: {msg}"),
        ...
        private void InjectDevicePixelRatio()
        {
            if (webViewObject != null)
            {
                ...
                // Device ratio fix, depends on Gree Webview Plugin to be installed
                GameObject devicePixelRatioObject = GameObject.Find("WebViewObject");
                if (devicePixelRatioObject != null)
                {
                    devicePixelRatioObject.GetComponent<WebViewObject>().devicePixelRatio = pixelRatio;
                }
#endif
            }
        }
